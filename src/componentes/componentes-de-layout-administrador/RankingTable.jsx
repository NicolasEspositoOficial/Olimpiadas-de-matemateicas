          ...
          {data.length > 0 ? (
            data.map((usuario, index) => (
              <tr key={index} style={{ textAlign: 'center' }}>
                <td className='estilo-de-informacion-tabla-rankin-usuarios'>{usuario.nombre || 'Sin nombre'}</td>
                <td className='estilo-de-informacion-tabla-rankin-usuarios'>{usuario.aciertos || 0}</td>
                <td className='estilo-de-informacion-tabla-rankin-usuarios'>{usuario.grado || '--'}</td>
                <td className='estilo-de-informacion-tabla-rankin-usuarios'>{usuario.tiempo || '--:--'}</td>                
              </tr>
            ))
          ) : (
            <tr>
